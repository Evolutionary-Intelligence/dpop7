...
# Univariate Marginal Distribution Algorithm (a serial implementation)
...
class DUMDA(DO):
    ...
    .. code-block:: python
       ...
       >>> dumda = DUMDA(problem, options)  # initialize the optimizer class
       >>> results = dumda.optimize()  # run the parallel optimization process
       >>> print(f"DUMDA: {results['n_function_evaluations']}, {results['best_so_far_y']}")
    """
    def __init__(self, problem, options):
        ...
        self._optimizer = UMDA  # class of Univariate Marginal Distribution Algorithm as the base of each island
