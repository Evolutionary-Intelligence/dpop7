...
# Self-Adaptation Evolution Strategy (a serial implementation)
...
class DSAES(DO):
    ...
    .. code-block:: python
       ...
       >>> from dpop7.optimizers.island.dsaes import DSAES
       ...
       >>> results = dsaes.optimize()  # run the parallel optimization process
    ...
    def __init__(self, problem, options):
        ...
        self._optimizer = SAES  # class of Self-Adaptation Evolution Strategy as the base of each island
