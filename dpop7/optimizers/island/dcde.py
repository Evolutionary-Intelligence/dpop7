...
# Classic Differential Evolution (a serial implementation)
...
class DCDE(DO):
    ...
    .. code-block:: python
       ...
       >>> from dpop7.optimizers.island.dcde import DCDE
    ...
    def __init__(self, problem, options):
        ...
        self._optimizer = CDE  # class of Classic Differential Evolution as the base of each island
