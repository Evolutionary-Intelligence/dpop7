...
# Separable Natural Evolution Strategies (a serial implementation)
...
class DSNES(DO):
    ...
    .. code-block:: python
       ...
       >>> from pypop7.optimizers.dnes.dsnes import DSNES
       ...
       >>> results = dsnes.optimize()  # run the parallel optimization process
    ...
    def __init__(self, problem, options):
        ...
        self._optimizer = SNES  # class of Separable Natural Evolution Strategies as the base of each island
