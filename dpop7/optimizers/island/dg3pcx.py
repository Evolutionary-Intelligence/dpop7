...
# Generalized Generation Gap with Parent-Centric Recombination (a serial implementation)
...
class DG3PCX(DO):
    ...
    .. code-block:: python
       ...
       >>> from dpop7.optimizers.island.dg3pcx import DG3PCX
       ...
       >>> results = dg3pcx.optimize()  # run the parallel optimization process
    ...
    def __init__(self, problem, options):
        ...
        # use class of Generalized Generation Gap with Parent-Centric Recombination as the base of each island
        self._optimizer = G3PCX
