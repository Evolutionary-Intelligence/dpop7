...
# Classical Evolutionary Programming (a serial implementation)
...
class DCEP(DO):
    """Distributed Classical Evolutionary Programming (DCEP).
    ...
    .. code-block:: python
       ...
       >>> from dpop7.optimizers.island.dcep import DCEP
       ...
       >>> results = dcep.optimize()  # run the parallel optimization process
    ...
    def __init__(self, problem, options):
        ...
        self._optimizer = CEP  # class of Classical Evolutionary Programming as the base of each island
