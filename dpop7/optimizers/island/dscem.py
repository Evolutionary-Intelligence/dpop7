...
# Standard Cross-Entropy Method (a serial implementation)
...
class DSCEM(DO):
    ...
    .. code-block:: python
       ...
       >>> results = dscem.optimize()  # run the parallel optimization process
    ...
    def __init__(self, problem, options):
        ...
        self._optimizer = SCEM  # class of Standard Cross-Entropy Method as the base of each island
