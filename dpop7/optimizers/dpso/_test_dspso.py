...
from dpop7.optimizers.dpso.dspso import DSPSO  # Distributed Standard Particle Swarm Optimizer
...
if __name__ == '__main__':
    ...
    results = dspso.optimize()  # run the optimization process
    ...
    # DSPSO: 100000, 25736726.758652825
